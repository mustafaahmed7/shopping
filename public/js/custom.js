...
$screensize = $(window).width();
    if ($screensize > 1199) {
		$(".product-category.product_tab_grid > .clearfix").remove();
        $('.product-category.product_tab_grid .product-grid:nth-child(4n)').after('<span class="clearfix visible-lg-block"></span>');
    }
    if ($screensize < 1199) {
		$(".product-category.product_tab_grid > .clearfix").remove();
        $('.product-category.product_tab_grid .product-grid:nth-child(4n)').after('<span class="clearfix visible-lg-block visible-md-block"></span>');
    }
	if ($screensize < 991) {
		$(".product-category.product_tab_grid > .clearfix").remove();
        $('.product-category.product_tab_grid .product-grid:nth-child(3n)').after('<span class="clearfix visible-lg-block visible-sm-block"></span>');
    }
	if ($screensize < 767) {
        $(".product-category.product_tab_grid > .clearfix").remove();
		$('.product-category.product_tab_grid .product-grid:nth-child(2n)').after('<span class="clearfix visible-lg-block visible-xs-block"></span>');
    }
...
$('#list-view').on("click", function() {
	$(".product-category > .clearfix.visible-lg-block").remove();
...
$screensize = $(window).width();
    if ($screensize > 1199) {
		$(".product-category > .clearfix").remove();
